...
public class Patrol : State
{
    ...
    public override void Enter()
    {
        ...
        for(int i = 0; i < GameEnvironment.Singleton.Checkpoint.Count; i++)
        {
            GameObject thisWp = GameEnvironment.Singleton.Checkpoint[i];
    ...
    public override void Update()
    {
        ...
        {
            if(currentIndex >= GameEnvironment.Singleton.Checkpoint.Count - 1)
            {
                currentIndex = 0;
            }
            else
            ...
            agent.SetDestination(GameEnvironment.Singleton.Checkpoint[currentIndex].transform.position);
        }
